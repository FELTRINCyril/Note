...
struct BlockRenderRoutingTests {
    ...
    @Test("La base de donnees inline (Phase 17) route desormais vers un rendu reel")
    func databaseViewRoutesToRealKind() {
        #expect(BlockRenderRouting.kind(for: .databaseView) == .databaseView)
    }
