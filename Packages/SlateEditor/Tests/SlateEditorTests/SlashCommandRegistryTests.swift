...
struct SlashCommandRegistryTests {
    ...
    @Test("Le registre couvre exactement les 13 types de bloc a rendu textuel reel")
    ...
    @Test("Aucun type reserve a une phase ulterieure n'apparait dans le registre")
